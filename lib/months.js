/* מטא-נתונים קבועים של 13 חודשי תשפ"ז (שנה מעוברת).
   ...
   הלוח כולל את חגי כל הקהילות בישראל; החגים המוסלמיים תלויים בראיית הירח והתאריכים משוערים.
   מקרא: ✡️ יהודי · ☪️ מוסלמי · ✝️ נוצרי · ⭐ דרוזי · 🏹 צ'רקסי · 🇮🇱 ממלכתי · 🎉 אזרחי
...
export const MONTHS_META = [
  ...
  { id: '12-av', name: 'אב',      greg: 'אוגוסט 2027', calTitle: 'אוגוסט 2027', startDow: 0, days: 31,
    ...
    holidays: { 12: '✡️ תשעה באב', 14: '☪️ מולד הנביא', 18: '✡️ ט״ו באב' } },
  { id: '13-elul', name: 'אלול',  greg: 'ספטמבר 2027', calTitle: 'ספטמבר 2027', startDow: 3, days: 30,
    essence: 'ימי סליחות', hue: 260,
    holidays: { 10: '⭐ זיארת נבי סבלאן' } }
];

/* שורת המקרא המוצגת בכרטיס "חגי החודש" בעמודים השונים */
export const HOLIDAY_LEGEND = '✡️ יהודי · ☪️ מוסלמי · ✝️ נוצרי · ⭐ דרוזי · 🏹 צ׳רקסי · 🇮🇱 ממלכתי · 🎉 אזרחי';
